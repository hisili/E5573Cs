...
static struct usb_cdc_obex_desc acm_obex_desc_ften =
{
    .bLength		= sizeof(acm_obex_desc_ften),
    .bDescriptorType	= USB_DT_CS_INTERFACE,
    .bDescriptorSubType	= USB_CDC_OBEX_TYPE,
    .bcdVersion		= cpu_to_le16(0x0100),
};

static struct usb_cdc_union_desc acm_union_desc_single_ften =
{
    .bLength =		sizeof(acm_union_desc_single_ften),
    .bDescriptorType =	USB_DT_CS_INTERFACE,
    .bDescriptorSubType =	USB_CDC_UNION_TYPE,
    .bMasterInterface0 =	0x00,
    .bSlaveInterface0 =	0x00,
};

static struct usb_cdc_union_desc acm_union_desc_ften =
{
    .bLength =		sizeof(acm_union_desc_ften),
    .bDescriptorType =	USB_DT_CS_INTERFACE,
    .bDescriptorSubType =	USB_CDC_UNION_TYPE,
...
static struct usb_cdc_mdlm_desc acm_mdlm_desc_ften =
{
    .bLength		= sizeof(acm_mdlm_desc_ften),
    .bDescriptorType	= USB_DT_CS_INTERFACE,
    .bDescriptorSubType	= USB_CDC_MDLM_TYPE,
    .bcdVersion		= cpu_to_le16(0x0120),
    .bGUID      = 0x00,
};

static struct usb_cdc_mdlm_detail_desc acm_mdlm_detail_desc_ften =
{
    .bLength		= sizeof(acm_mdlm_detail_desc_ften),
    .bDescriptorType	= USB_DT_CS_INTERFACE,
    .bDescriptorSubType	= USB_CDC_MDLM_DETAIL_TYPE,
    .bGuidDescriptorType = 0x00,
    .bDetailData      = {0x01, 0x10},
};

static struct usb_cdc_foma_desc acm_foma_desc_ften =
{
    .bLength		= sizeof(acm_foma_desc_ften),
    .bDescriptorType	= UBS_DT_CS_VENDOR,
    .bDescriptorSubType	= USB_CDC_WHCM_TYPE,
    .bType              = 0x02,
    .bMode_0            = 0x01,
};

static struct usb_cdc_call_mgmt_descriptor acm_call_mgmt_descriptor_ften =
{
    .bLength =		sizeof(acm_call_mgmt_descriptor_ften),
    .bDescriptorType =	USB_DT_CS_INTERFACE,
    .bDescriptorSubType =	USB_CDC_CALL_MANAGEMENT_TYPE,
    .bmCapabilities =	0x03,
    .bDataInterface = 0x02,
...
static struct usb_cdc_acm_descriptor acm_descriptor_ften =
{
    .bLength =		sizeof(acm_descriptor_ften),
    .bDescriptorType =	USB_DT_CS_INTERFACE,
    .bDescriptorSubType =	USB_CDC_ACM_TYPE,
    .bmCapabilities =	0x0A,
};

static struct usb_endpoint_descriptor acm_fs_in_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bEndpointAddress =	USB_DIR_IN,
...
static struct usb_endpoint_descriptor acm_fs_out_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bEndpointAddress =	USB_DIR_OUT,
...
static struct usb_endpoint_descriptor acm_hs_in_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bmAttributes =		USB_ENDPOINT_XFER_BULK,
...
static struct usb_endpoint_descriptor acm_hs_out_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bmAttributes =		USB_ENDPOINT_XFER_BULK,
...
static struct usb_endpoint_descriptor acm_ss_in_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bmAttributes =		USB_ENDPOINT_XFER_BULK,
...
static struct usb_endpoint_descriptor acm_ss_out_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bmAttributes =		USB_ENDPOINT_XFER_BULK,
...
static struct usb_interface_descriptor acm_single_interface_desc_ften =
{
    .bLength =		USB_DT_INTERFACE_SIZE,
    .bDescriptorType =	USB_DT_INTERFACE,
...
static struct usb_interface_descriptor acm_control_interface_desc_ften =
{
    .bLength =		USB_DT_INTERFACE_SIZE,
    .bDescriptorType =	USB_DT_INTERFACE,
...
static struct usb_interface_descriptor acm_data_interface_desc_ften =
{
    .bLength =		USB_DT_INTERFACE_SIZE,
    .bDescriptorType =	USB_DT_INTERFACE,
...
static struct usb_endpoint_descriptor acm_fs_notify_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bEndpointAddress =	USB_DIR_IN,
...
static struct usb_endpoint_descriptor acm_hs_notify_desc_ften =
{
    .bLength =		USB_DT_ENDPOINT_SIZE,
    .bDescriptorType =	USB_DT_ENDPOINT,
    .bEndpointAddress =	USB_DIR_IN,
...
static struct usb_descriptor_header* acm_fs_function_single_ften[] =
{
    (struct usb_descriptor_header*)& acm_single_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_fs_in_desc_ften,
    (struct usb_descriptor_header*)& acm_fs_out_desc,
    (struct usb_descriptor_header*)& acm_header_desc,
    (struct usb_descriptor_header*)& acm_obex_desc_ften,
    (struct usb_descriptor_header*)& acm_union_desc_single_ften,
    (struct usb_descriptor_header*)& acm_mdlm_desc_ften,
    (struct usb_descriptor_header*)& acm_mdlm_detail_desc_ften,
    (struct usb_descriptor_header*)& acm_foma_desc_ften,
    NULL,
};

static struct usb_descriptor_header* acm_hs_function_single_ften[] =
{
    (struct usb_descriptor_header*)& acm_single_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_hs_in_desc_ften,
    (struct usb_descriptor_header*)& acm_hs_out_desc_ften,
    (struct usb_descriptor_header*)& acm_header_desc,
    (struct usb_descriptor_header*)& acm_obex_desc_ften,
    (struct usb_descriptor_header*)& acm_union_desc_single_ften,
    (struct usb_descriptor_header*)& acm_mdlm_desc_ften,
...
static struct usb_descriptor_header* acm_ss_function_single_ften[] =
{
    (struct usb_descriptor_header*)& acm_single_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_ss_in_desc,
    (struct usb_descriptor_header*)& acm_ss_bulk_comp_desc,
...
static struct usb_descriptor_header* acm_fs_function_ften[] =
{
    //(struct usb_descriptor_header*)& acm_iad_descriptor,
    (struct usb_descriptor_header*)& acm_control_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_header_desc,
    (struct usb_descriptor_header*)& acm_call_mgmt_descriptor_ften,
    (struct usb_descriptor_header*)& acm_descriptor_ften,
    (struct usb_descriptor_header*)& acm_union_desc_ften,
    (struct usb_descriptor_header*)& acm_foma_desc_ften,
    (struct usb_descriptor_header*)& acm_hs_notify_desc_ften,
    (struct usb_descriptor_header*)& acm_data_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_fs_in_desc_ften,
    (struct usb_descriptor_header*)& acm_fs_out_desc_ften,
    NULL,
};

static struct usb_descriptor_header* acm_hs_function_ften[] =
{
    //(struct usb_descriptor_header*)& acm_iad_descriptor,
    (struct usb_descriptor_header*)& acm_control_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_header_desc,
...
static struct usb_descriptor_header* acm_ss_function_ften[] =
{
    //(struct usb_descriptor_header*)& acm_iad_descriptor,
    (struct usb_descriptor_header*)& acm_control_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_header_desc,
    ...
    (struct usb_descriptor_header*)& acm_ss_bulk_comp_desc,
    (struct usb_descriptor_header*)& acm_data_interface_desc_ften,
    (struct usb_descriptor_header*)& acm_ss_in_desc_ften,
    (struct usb_descriptor_header*)& acm_ss_bulk_comp_desc,
    (struct usb_descriptor_header*)& acm_ss_out_desc_ften,
    (struct usb_descriptor_header*)& acm_ss_bulk_comp_desc,
    NULL,
};
#endif
...
acm_bind(struct usb_configuration* c, struct usb_function* f)
{
...
#if(FEATURE_OFF == MBB_USB_FTEN_SWITCH)
    ...
    if (acm->support_notify)
    {
        ...
        {
            ep = usb_ep_autoconfig(cdev->gadget, &acm_fs_notify_desc_ften);
        }
        else
        {
    ...
    if (FTEN_USB_DESC_FTEN == get_ften_desc_flag())
    {
        ep = usb_ep_autoconfig(cdev->gadget, &acm_fs_in_desc_ften);
        if (!ep)
        { goto fail; }
        acm->port.in = ep;
        ep->driver_data = cdev; /* claim */

        ep = usb_ep_autoconfig(cdev->gadget, &acm_fs_out_desc_ften);
        if (!ep)
        { goto fail; }
        acm->port.out = ep;
        ep->driver_data = cdev; /* claim */
        ...
        */
        ...
        {
            acm_hs_in_desc_ften.bEndpointAddress =
                acm_fs_in_desc_ften.bEndpointAddress;
            acm_hs_out_desc_ften.bEndpointAddress =
                acm_fs_out_desc_ften.bEndpointAddress;

            if (acm->support_notify)
            {
                acm_hs_notify_desc_ften.bEndpointAddress =
                    acm_fs_notify_desc_ften.bEndpointAddress;
            }
        ...
        {
            acm_ss_in_desc_ften.bEndpointAddress =
                acm_fs_in_desc_ften.bEndpointAddress;
...
static inline USB_VOID acm_set_config_vendor(struct f_acm* acm)
{
    ...
    if (g_acm_is_single_interface)
    {
        ...
        if (usb_pnp_port_style_stat() || pnp_if_static_port_mode())
        {
...
#if(FEATURE_ON == MBB_USB_FTEN_SWITCH)
static inline USB_VOID acm_set_config_vendor_ften(struct f_acm* acm)
{

    if (g_acm_is_single_interface)
    {
        acm_fs_cur_function = acm_fs_function_single_ften;
        acm_hs_cur_function = acm_hs_function_single_ften;
        acm_ss_cur_function = acm_ss_function_single_ften;
    }
    else
    {
        acm_fs_cur_function = acm_fs_function_ften;
        acm_hs_cur_function = acm_hs_function_ften;
        acm_ss_cur_function = acm_ss_function_ften;
    }
                        ...
                        enum acm_class_type type, struct android_usb_function* f)
{
    ...
    if (FTEN_USB_DESC_FTEN == get_ften_desc_flag())
    {
        acm_set_config_vendor_ften(acm);
    }
    else
    {
...
#if(FEATURE_ON == MBB_USB_FTEN_SWITCH)
    if ((!strcmp(f->name, "3g_modem") || !strcmp(f->name, "modem"))
        && (FTEN_USB_DESC_FTEN == get_ften_desc_flag()))
    {
        g_acm_is_single_interface = 0;
    }
    else
    {
        g_acm_is_single_interface = 1;
    }
#endif
