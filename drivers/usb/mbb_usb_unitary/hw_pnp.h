...
/*nv:no autorun*/
#define USB_NV_NO_AUTORUN_ID            61
...
#define SC_MAC_SYS          0xbb
#define SC_WIN_SYS          0xa2
#endif
...
#define FTEN_MODE_PID  0x021B
#define FTEN_VENDOR_ID 0x0619
#define FTEN_USB_ENUM_DONE 1
#define FTEN_USB_SWITCH_FTEN 0
#define FTEN_USB_SWITCH_MICRO 1
#define FTEN_USB_SWITCH_ADAPTER 2
#define FTEN_USB_DESC_FTEN 0
#define FTEN_USB_DESC_HUAWEI 1
#define FTEN_USB_TRUE 1
#define FTEN_USB_FALSE 0
#endif

#define DEFAULT_PID           0x1446
#define LOW_LINUX_PID         0x1001

#if ((FEATURE_ON == MBB_FEATURE_GATEWAY) && defined(CUSTOM_LIVEBOX_PID))
#define LIVEBOX_COSTOMIZE_PID 0x1c2B
#define GATEWAY_NDIS_PID      LIVEBOX_COSTOMIZE_PID
#else
...
typedef enum
{
    ...
    POWER_OFF_MODE,                  /*25*/
    #if(FEATURE_ON == MBB_USB_FTEN_SWITCH)
    FTEN_USB_SWITCH_MODE,       /*26*/
    #endif
    /**/
    DYNAMIC_REWIND_BEFORE_MODE,      /*27*/
    DYNAMIC_REWIND_AFTER_MODE,       /*28*/
    DYNAMIC_DEBUG_MODE,              /*29*/
    HILINK_PORT_MODEM_MODE,          /*30*/
    HILINK_PORT_MODEM_DEBUG_MODE,    /*31*/
    INVALID_MODE,                    /*32*/
} ports_enum_mode;
...
USB_VOID set_ften_enum_flag(USB_INT);
USB_INT get_ften_desc_flag(USB_VOID);
USB_VOID set_ften_desc_flag(USB_INT);
USB_INT get_ften_cur_usb(USB_VOID);
USB_VOID set_ften_cur_usb(USB_INT);
USB_INT get_ften_supply_type(USB_VOID);
USB_VOID set_ften_supply_type(USB_INT);
#endif
