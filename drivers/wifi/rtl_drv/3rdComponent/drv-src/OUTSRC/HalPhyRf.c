...
//	BOOLEAN 		bInteralPA = FALSE;
    ...
    memcpy(deltaSwingTableIdx, pDM_Odm->priv->pshare->deltaSwingTableIdx_88E, 2 * index_mapping_NUM_88E);
    memcpy(thermalThreshold, pDM_Odm->priv->pshare->thermalThreshold_88E, 2 * index_mapping_NUM_88E);
    {
        static int print_debug = 1;
        if (print_debug)
        {
            print_debug = 0;
            printk("deltaSwing0 %d %d %d %d %d %d %d %d %d %d %d %d %d %d  %d\n", deltaSwingTableIdx[0][0], deltaSwingTableIdx[0][1], deltaSwingTableIdx[0][2], deltaSwingTableIdx[0][3]
                   , deltaSwingTableIdx[0][4], deltaSwingTableIdx[0][5], deltaSwingTableIdx[0][6], deltaSwingTableIdx[0][7], deltaSwingTableIdx[0][8]
                   , deltaSwingTableIdx[0][9], deltaSwingTableIdx[0][10], deltaSwingTableIdx[0][11], deltaSwingTableIdx[0][12], deltaSwingTableIdx[0][13]
                   , deltaSwingTableIdx[0][14]);
            printk("deltaSwing1 %d %d %d %d %d %d %d %d %d %d %d %d %d %d  %d\n", deltaSwingTableIdx[1][0], deltaSwingTableIdx[1][1], deltaSwingTableIdx[1][2], deltaSwingTableIdx[1][3]
                   , deltaSwingTableIdx[1][4], deltaSwingTableIdx[1][5], deltaSwingTableIdx[1][6], deltaSwingTableIdx[1][7], deltaSwingTableIdx[1][8]
                   , deltaSwingTableIdx[1][9], deltaSwingTableIdx[1][10], deltaSwingTableIdx[1][11], deltaSwingTableIdx[1][12], deltaSwingTableIdx[1][13]
                   , deltaSwingTableIdx[1][14]);
            printk("thermal0 %d %d %d %d %d %d %d %d %d %d %d %d %d %d  %d\n", thermalThreshold[0][0], thermalThreshold[0][1], thermalThreshold[0][2], thermalThreshold[0][3]
                   , thermalThreshold[0][4], thermalThreshold[0][5], thermalThreshold[0][6], thermalThreshold[0][7], thermalThreshold[0][8]
                   , thermalThreshold[0][9], thermalThreshold[0][10], thermalThreshold[0][11], thermalThreshold[0][12], thermalThreshold[0][13]
                   , thermalThreshold[0][14]);
            printk("thermal1 %d %d %d %d %d %d %d %d %d %d %d %d %d %d  %d\n", thermalThreshold[1][0], thermalThreshold[1][1], thermalThreshold[1][2], thermalThreshold[1][3]
                   , thermalThreshold[1][4], thermalThreshold[1][5], thermalThreshold[1][6], thermalThreshold[1][7], thermalThreshold[1][8]
                   , thermalThreshold[1][9], thermalThreshold[1][10], thermalThreshold[1][11], thermalThreshold[1][12], thermalThreshold[1][13]
                   , thermalThreshold[1][14]);
        }
    }
#endif
