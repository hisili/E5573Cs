	...
	)
{
	...
	switch	(CmnInfo)
	{
		...
		case	ODM_CMNINFO_EXT_LNA_CCK_CCA_HI:
			pDM_Odm->cck_cca_hi = (u1Byte)Value;
			break;
		case	ODM_CMNINFO_EXT_LNA_CCK_CCA_LOW:
			pDM_Odm->cck_cca_low = (u1Byte)Value;
			break;
		case	ODM_CMNINFO_EXT_LNA_RX_GAIN_HI:
			pDM_Odm->lna_rx_hi = (u1Byte)Value;
			break;
		case	ODM_CMNINFO_EXT_LNA_RX_GAIN_LOW:
			pDM_Odm->lna_rx_low = (u1Byte)Value;
			break;
			
		case	ODM_CMNINFO_EXT_LNA_RSSI_OFFSET:
			pDM_Odm->RssiOffset = (s1Byte)Value;
			break;
		case	ODM_CMNINFO_EXT_LNA_OFDM_RSSI_OFFSET:
			pDM_Odm->ofdmRssiOffset = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_7:
			pDM_Odm->rx_pwr_7 = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_6:
			pDM_Odm->rx_pwr_6 = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_5:
			pDM_Odm->rx_pwr_5 = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_4:
			pDM_Odm->rx_pwr_4 = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_3:
			pDM_Odm->rx_pwr_3 = (s1Byte)Value;
			break;								
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_2:
			pDM_Odm->rx_pwr_2 = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_1:
			pDM_Odm->rx_pwr_1 = (s1Byte)Value;
			break;			
        case	ODM_CMNINFO_EXT_LNA_RX_PWR_0:
			pDM_Odm->rx_pwr_0 = (s1Byte)Value;
			break;			
