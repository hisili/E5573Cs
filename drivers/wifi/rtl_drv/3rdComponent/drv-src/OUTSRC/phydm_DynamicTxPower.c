...
//#endif	
    ...
    {
        extern void set_1cca_enable(struct rtl8192cd_priv *priv, int enable_1cca);
        set_1cca_enable(priv, (((0 == priv->pshare->total_assoc_num) || priv->pshare->phw->lower_tx_power) ? 1 : 0));
    }
