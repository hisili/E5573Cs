...
#define 	PHYDM_BCD 	 BIT2 | BIT3 | BIT4 // 0
#define 	PHYDM_ACD 	 BIT0 | BIT3 | BIT4 // 1
#define 	PHYDM_ABD 	 BIT0 | BIT1 | BIT4 // 2
#define 	PHYDM_ABC 	 BIT0 | BIT1 | BIT2 // 3
...
typedef struct _ODM_PATH_DIVERSITY_
{
  ...
  #if RTL8814A_SUPPORT
	//u4Byte	PathC_Sum[ODM_ASSOCIATE_ENTRY_NUM];
	//u4Byte	PathD_Sum[ODM_ASSOCIATE_ENTRY_NUM];
	//u2Byte	PathC_Cnt[ODM_ASSOCIATE_ENTRY_NUM];
	//u2Byte	PathD_Cnt[ODM_ASSOCIATE_ENTRY_NUM];
