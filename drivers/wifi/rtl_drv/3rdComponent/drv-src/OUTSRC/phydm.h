...
//-------------REMOVED CASE-----------//
	...
	ODM_CMNINFO_EXT_LNA_RSSI_OFFSET,
	ODM_CMNINFO_EXT_LNA_OFDM_RSSI_OFFSET,	
	ODM_CMNINFO_EXT_LNA_RX_PWR_7,
	ODM_CMNINFO_EXT_LNA_RX_PWR_6,
	ODM_CMNINFO_EXT_LNA_RX_PWR_5,
	ODM_CMNINFO_EXT_LNA_RX_PWR_4,
    ODM_CMNINFO_EXT_LNA_RX_PWR_3,
    ODM_CMNINFO_EXT_LNA_RX_PWR_2,
    ODM_CMNINFO_EXT_LNA_RX_PWR_1,
    ODM_CMNINFO_EXT_LNA_RX_PWR_0,
    ODM_CMNINFO_EXT_LNA_CCK_CCA_HI,
    ODM_CMNINFO_EXT_LNA_CCK_CCA_LOW,
    ODM_CMNINFO_EXT_LNA_RX_GAIN_HI,
    ODM_CMNINFO_EXT_LNA_RX_GAIN_LOW,
...
//-----------HOOK BEFORE REG INIT-----------//	
	...
	u1Byte			cck_cca_hi; // 2G
	u1Byte			cck_cca_low; // 2G
	u1Byte			lna_rx_hi; // 2G
	u1Byte			lna_rx_low; // 2G
	
	s1Byte			RssiOffset; // 2G
	s1Byte			ofdmRssiOffset;		
	s1Byte			rx_pwr_7;
	s1Byte			rx_pwr_6;
	s1Byte			rx_pwr_5;
	s1Byte			rx_pwr_4;
