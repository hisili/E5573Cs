...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
    {
        ...
        //ODM_SetBBReg(pDM_Odm,rOFDM0_ECCAThreshold, bMaskByte1, 0x0); // set forgetting factor = 0 for all n series IC
    }
	else if(pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
    ...
    /* END PN: DTS2015081707230,Modified by hwx235258, 2015/08/26*/
}
