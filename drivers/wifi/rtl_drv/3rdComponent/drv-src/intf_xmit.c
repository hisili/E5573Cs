...
int rtw_xmit_enqueue(struct rtl8192cd_priv *priv, struct tx_insn *txcfg)
{
    ...
    if (priv->pshare->free_xmit_queue.qlen < CFG_FC_TX_FREE_QLEN_SIZE)
    {
        return FALSE;
    }
    #endif
	...
	if (pxmitbuf) {
		...
		if ((txcfg == pxmitbuf->agg_start_with) && pxmitbuf->use_hw_queue) {
...
#endif // CONFIG_SDIO_HCI
			{
                ...
                /* BEGIN PN: DTS2014082509755,Added by z00189113, 2014/11/10 */
                ...
                /* END PN: DTS2014082509755,Added by z00189113, 2014/11/10 */
			}
		}
	}
}
