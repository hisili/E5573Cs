...
struct Dot11RFEntry {
    ...
    unsigned int    dot11ch_mask;
    unsigned int    tserlf_lock_enable;
...
struct MiscEntry {
...
#ifdef WLAN_PLATFORM_HUAWEI_COMMON
    int	cost_ie_attr;  //cost ie ¨º?D?¡Á???(flag & leve)
#endif /* WLAN_PLATFORM_HUAWEI_COMMON */
	...
	unsigned int    max_rx_agg_sz;
    unsigned int    max_tx_agg;
};
