...
*/
    ...
    #define DEBUG_INFO(fmt, ...)   rtl_printk(WLAN_LOG_DRV_HI, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
    #define PRINT_INFO  DEBUG_INFO
    
    #define DEBUG_WARN(fmt, ...)   rtl_printk(WLAN_LOG_DRV_MID, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
    #define DEBUG_ERR   DEBUG_WARN
