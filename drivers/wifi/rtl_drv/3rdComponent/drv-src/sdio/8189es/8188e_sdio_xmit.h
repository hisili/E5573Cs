...
#else
#define MAX_BCN_XMITBUF_SZ      (1024)
#endif
...
static inline int rtw_sdio_check_TxOQT_space(struct rtl8192cd_priv *priv, u8 agg_num)
{
    return (GET_HAL_INTF_DATA(priv)->SdioTxOQTFreeSpace < agg_num) ? FALSE : TRUE;
}
#endif
