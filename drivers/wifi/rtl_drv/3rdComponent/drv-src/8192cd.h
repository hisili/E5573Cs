...
#define WLAN_PLATFORM_HUAWEI_COMMON
#endif
...
#ifndef WLAN_EVENT_WPA
#define WLAN_EVENT_WPA
#endif

#ifndef SOFTAP_PS_DURATION
#define SOFTAP_PS_DURATION
#endif

#ifndef CONFIG_MEM_USE_CACHE
#define CONFIG_MEM_USE_CACHE
#endif

#ifndef WLAN_PLATFORM_BALONG_V7
#define WLAN_PLATFORM_BALONG_V7
#endif

#ifndef INTEL_BEACON_POWER_NO_INC
#define INTEL_BEACON_POWER_NO_INC
#endif

#ifndef WLAN_PLATFORM_HUAWEI_FACTORY
#define WLAN_PLATFORM_HUAWEI_FACTORY
#endif
...
typedef enum _RTW_BEACON_ENUM_
{
    RTW_BEACON_NORMAL   = 0,     
    RTW_BEACON_DLOAD    = 1,    
    RTW_BEACON_SUSPEND  = 0xFF, 
}RTW_BEACON_ENUM_T;

#ifdef CONFIG_RTL_88E_SUPPORT
    #define RTW_BEACON_DELAY    (0) /* RTL8189 */
#else
    #define RTW_BEACON_DELAY    (2) /* RTL8192 */
#endif
#endif
...
enum wifi_state {
    ...
    WIFI_MP_CTX_BACKGROUND_STOPPING = 0x08000000,   // stopping ctx
...
enum _H2C_CMD_ID_ {
	...
	H2C_CMD_INFO_PKT = 13,
	H2C_CMD_SMCC = 14,
#if defined(SOFTAP_PS_DURATION) || defined(SDIO_AP_OFFLOAD)
	H2C_PS_SOFTAP = 38,
#endif
...
struct rf_finetune_var {
    ...
    unsigned char        force_1t2r;
    unsigned char        force_1t2r_already;
...
//#endif
...
#endif
    char                rssi_offset;
    char                ofdm_rssi_offset;
#ifdef HIGH_POWER_EXT_LNA
	unsigned char		use_ext_lna;
    unsigned char       ext_lna_gain;
    unsigned char       cck_cca_hi;
    unsigned char       cck_cca_low;
    unsigned char       lna_rx_hi;
    unsigned char       lna_rx_low;
    ...
    unsigned char       edca_turbo;          /* 0: normal 1: vie */

#ifdef CONFIG_1RCCA_RF_POWER_SAVING
    unsigned char       enable_1cca;         /* 0: off 1: on */
#endif
#ifdef DFS
...
//	unsigned char		mp_dig_enable;
    ...
    unsigned char       bcn_dont_ignore_edcca;
};
...
struct priv_shared_info {
    ...
    u8 offload_function_ctrl;
        ...
        struct timer_list      autoch_timer;   //auto-channel selection timer
        #if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
            struct timer_event_entry    autoch_timer_event;
        #endif
        s16                     autoch_to;      // seconds. time to expire before auto-channel selection.
...
#endif
#ifdef CONFIG_RTL_88E_SUPPORT
    unsigned char            deltaSwingTableIdx_88E[2][index_mapping_NUM_88E];
    unsigned char            thermalThreshold_88E[2][index_mapping_NUM_88E];
#endif
...
#endif	
#endif
    unsigned int    intel_sta_bitmap;
#ifdef CONFIG_RTL_88E_SUPPORT
	unsigned int 	marvellMapBit_88e_hw_ext;
    unsigned int    intel_sta_bitmap_88e_ext;
#endif
#ifdef STA_EXT
	unsigned int 	marvellMapBitExt;
    unsigned int    intel_sta_bitmap_ext;
#endif
...
//#define BCN_BUF ((RTL8192CD_NUM_VWLAN+1)*1024)
#define BCN_BUF  (256) // need at least 2 page //2048
...
//	unsigned int			ampdu_first_dma_desc;
    ...
    unsigned char offload_rsp_page;
...
struct brsc_cache_t {
    ...
    #define IS_CH_AVAIL(priv, ch) ((ch >= 1 && ch <= 14) \
        && (0x01 & (GET_ROOT(priv)->pmib->dot11RFEntry.dot11ch_mask >> (ch - 1))))
    #define IS_TESLF_LOCK_ENABLE( )(GET_ROOT(priv)->pmib->dot11RFEntry.tserlf_lock_enable == 0 ? 0:1)    /*是否打开天线锁口*/
