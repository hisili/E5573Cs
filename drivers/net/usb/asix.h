...
struct AX88772B_BULKIN_SIZE_STRU
{
    unsigned short size;
...
struct CICADA_FAMILY_HWINIT_STRU
{
    unsigned short value; 
    unsigned short offset; 
};
struct CICADA_V2_HWINIT_STRU
{
    unsigned short value; 
    unsigned short offset; 
};
struct CICADA_V2_ASIX_HWINIT_STRU
{
    unsigned short value; 
    unsigned short offset; 
};
struct AGERE_FAMILY_HWINIT_STRU
{
    unsigned short value; 
    unsigned short offset; 
};
