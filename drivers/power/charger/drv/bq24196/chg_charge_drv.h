...
#define CHG_WIRELESS_DPM_VOLT              (4760)
    ...
    || defined(BSP_CONFIG_BOARD_E5575S_210) || defined(BSP_CONFIG_BOARD_E5575S_320) \
    || defined(BSP_CONFIG_BOARD_401HW) || defined(BSP_CONFIG_BOARD_E5573S_156) \
    ...
    || defined(BSP_CONFIG_BOARD_R218h) || defined(BSP_CONFIG_BOARD_607HW)
#define CHG_DEFAULT_DPM_VOLT               (4600)
#define CHG_AF18_DPM_VOLT                  (4440)
#elif defined(BSP_CONFIG_BOARD_E5577S_603)
#define CHG_DEFAULT_DPM_VOLT               (4520)
#define CHG_AF18_DPM_VOLT                  (4440)
#elif defined(BSP_CONFIG_BOARD_E5577S_321) || defined(BSP_CONFIG_BOARD_E5577S_932) \
    || defined(BSP_CONFIG_BOARD_E5577S_324)
#define CHG_DEFAULT_DPM_VOLT               (4600)
#define CHG_AF18_DPM_VOLT                  (4440)
#define CHG_DEFAULT_DPM_VOLT_H             (4520)
#elif defined(BSP_CONFIG_BOARD_E5_E5770s) || defined(BSP_CONFIG_BOARD_E5771S_852) || defined(BSP_CONFIG_BOARD_E5771H_937)
#define CHG_DEFAULT_DPM_VOLT               (4440)
#define CHG_AF18_DPM_VOLT                  (4440)
#else
...
#define BQ24192_BATLOW_VOL_2V8       (2800)
#define BQ24192_BATLOW_VOL_3V        (3000)
