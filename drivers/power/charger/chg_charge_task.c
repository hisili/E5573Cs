...
#endif
extern int32_t is_5577cs_falg = FALSE;    /*FALSE:不是5577Cs-321;TRUE:是5577Cs-321*/
/**********************************************************************
...
void chg_task_init(void)
{
    ...
    /*判断是否是5577Cs-321,因为5577Cs-321与5577s-321二进制归一化，但是不支持对外充电*/
    unsigned int id = 0xffffffff;
    id = (unsigned int)bsp_version_get_boardid();//读取单板硬件ID
	/* E5577Ds-156为E5577Cs-321的子项目版本与E5577Cs-321和E5577s-321进行二进制归一，充电和电池的适配与E5577Cs-321一致*/
