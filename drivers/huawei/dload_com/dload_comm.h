...
/* 升级特性配置结构体 */
#define  FEATURE_FOTA_RES_NUM 20        /* FOTA预留 */
#define  FEATURE_RESERV_NUM   50 - FEATURE_FOTA_RES_NUM - sizeof(dload_safety1_3_t)     /* 升级预留特性个数 */
typedef struct _DLOAD_FEATURE
{
    ...
    dload_fota_feature_t          fota_feature; /* FOTA预留 */
