...
/*oem VSIM新增分区，用于存放产线预置的主卡数据文件*/
#define MBB_PTABLE_OEM_START                MBB_PTABLE_SYSTEM_END
#define MBB_PTABLE_OEM_END                  (MBB_PTABLE_OEM_START + MBB_PTABLE_OEM_LEN)

/*change usrdata and online partitions sequence in stick and hilink product currently*/
/*userdata*/
#define MBB_PTABLE_USERDATA_START           MBB_PTABLE_OEM_END
...
/*opensrc*/
#define MBB_PTABLE_OPENSRC_START           MBB_PTABLE_MMC_END
#define MBB_PTABLE_OPENSRC_END             (MBB_PTABLE_OPENSRC_START + MBB_PTABLE_OPENSRC_LEN)
/*cache*/
#define MBB_PTABLE_CACHE_START              MBB_PTABLE_OPENSRC_END
#else
...
#endif
#if(MBB_FEATURE_VSIM_HUK == FEATURE_ON)
#if (0 != MBB_PTABLE_OEM_LEN)
    {"oem"          ,MBB_PTABLE_OEM_START       ,0x00000000  ,MBB_PTABLE_OEM_LEN       ,0x00000000                 ,0x00000000                ,IMAGE_OEM        ,DATA_YAFFS | PTABLE_MOUNT_MTD                       ,0},
#endif
#endif
/*change usrdata and online partitions sequence in stick and hilink product currently*/
...
#endif
#ifdef BSP_CONFIG_BOARD_K5160
#if (0 != MBB_PTABLE_OPENSRC_LEN)
    {"opensrc"     ,MBB_PTABLE_OPENSRC_START  ,0x00000000  ,MBB_PTABLE_OPENSRC_LEN  ,0x00000000                 ,0x00000000                ,IMAGE_OPENSRC   ,DATA_YAFFS | PTABLE_MOUNT_MTD                       ,0},
#endif
#endif
