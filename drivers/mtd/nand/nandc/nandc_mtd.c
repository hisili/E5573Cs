...
#if (FEATURE_ON == MBB_DLOAD_MCPEUP)
    printk("smem_data->smem_dload_flag = 0x%x, smem_data->smem_forceload_flag = 0x%x, smem_data->smem_datalock_status = 0x%x!\n",
            smem_data->smem_dload_flag,smem_data->smem_forceload_flag, smem_data->smem_datalock_status);
#else
