...
{ 
    ...
    TYPE_NV_FACTORY_INFO_I,         /*32 用于记录产线工位的检测结果*/
    TYPE_NV_HUAWEI_BT_INFO_I,       /*33 蓝牙设备的MAC等配置信息*/
    TYPE_DATA_LOCK_HASH_VAL,        /*34 终端厂家私有密码hash值32字节*/
    ...
    TYPE_NV_VSIM_UE_MODE = 54,      /*54 判断卡模式，VSIM模式或者硬卡模式*/
    TYPE_SMS_CTRL_WIFI_INFO = 67,   /*67 MS2172s-818 定制功能 SMS CTRL WIFI*/
    TYPE_NV_MAX, 
}TYPE_KERNEL_NV_INFO; 
/*lint -e64 -e156 */

/**
* 此表中的NV ID和TYPE_KERNEL_NV_INFO中的枚举一一对应，
* 底软配置此处必须要通过申请才能添加或者修改
*/
unsigned long nv_index_table[TYPE_NV_MAX + 1] = \ 
{
    ...
    {NULL},                                      /* 47 预留 */
    {NULL},                                      /* 48 FOTA演进版本的设置 */     
    {NULL},                                      /* 49 USB log控制管理，对应NV 50498 */
    {NULL},                                      /* 50 webui随机密码 */
