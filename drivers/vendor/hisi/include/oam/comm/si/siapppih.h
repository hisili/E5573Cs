...
/* Added by h59254 for V7R1C50 ISDB Project,  2012-8-27 end */
    ...
    SI_PIH_EVENT_HVADH_SET_CNF   = 25,          /*^HVADH设置命令返回*/
    SI_PIH_EVENT_HVSCONT_SET_CNF = 26,          /*^HVSCONT设置命令返回*/
    SI_PIH_EVENT_HVSHDH_SET_CNF  = 27,        /*^hvshdh 设置命令返回*/
    SI_PIH_EVENT_HVDIEID_QRY_CNF  = 28,       /*^hvdieid 查询命令返回*/
    SI_PIH_EVENT_HVDDH_SET_CNF  = 29,        /*^hvddh 设置命令返回*/
...
{
    SI_PIH_SIM_REAL_SIM1          = 1,  /*硬卡*/
    SI_PIH_SIM_VIRT_PSIM          = 11, /*虚拟主卡*/
    SI_PIH_SIM_VIRT_SSIM          = 12, /*虚拟子卡*/
...
typedef struct
{
    ...
    SI_PIH_SIM_STATE_ENUM_UINT8         enVSimState;    /*vSIM卡状态*/
    SI_PIH_CARD_USE_ENUM_UINT8          enCardUse;      /*卡能否使用*/
    SI_PIH_SIM_INDEX_ENUM_UINT8         enVsimIndex;    /*确认是子卡还是主卡*/
}SI_PIH_EVENT_HVSST_QUERY_CNF_STRU;


typedef struct
{
    SI_PIH_SIM_INDEX_ENUM_UINT8         enVsimIndex;   /*卡索引*/
    VOS_UINT8                           aucRsv[3];     /*补位*/
    VSIM_ALGORITHM_TYPE_ENUM_UINT32     enAlgorithm;   /*加密方式*/
    VSIM_KEYDATA_STRU                   stCkey;        /*客户端公钥*/
    VSIM_KEYDATA_STRU                   stSkey;        /*服务器公钥*/
...
{
    SI_PIH_KEY_REAL_SIM1          = 1,  /*硬卡*/
    SI_PIH_KEY_VIRT_PSIM          = 11, /*虚拟主卡*/
    SI_PIH_KEY_VIRT_SSIM          = 12, /*虚拟子卡*/
...
typedef struct
{
    SI_PIH_KEY_INDEX_ENUM_UINT8         enKeyIndex;   /*卡索引*/
    VOS_UINT8                           aucRsv[3];     /*补位*/
...
{
    SI_PIH_CLEAN_KEY_ALL        = 0, /*清理所有密钥*/
    SI_PIH_CLEAN_KEY_PSIM,           /*清理主卡密钥*/
    SI_PIH_CLEAN_KEY_SSIM,           /*清理子卡密钥*/
    SI_PIH_CLEAN_KEY_DEVICE,         /*清理Device key */
    SI_PIH_CLEAN_KEY_CONTENT,        /*清理Content key*/
