...
#define DEVICE_KEY_PATH           ("/OEM/device_key.bin")
#define MASTER_KEY_PATH           ("/OEM/master_key.bin")
#define CONTENT_KEY_PATH          ("/OEM/content_key.bin")
#define MASTER_DATA1_PATH         ("/OEM/master_data1.bin")
#define MASTER_DATA2_PATH         ("/OEM/master_data2.bin")
#define HASH_PATH                 ("/OEM/hash.bin")

#define DEVICEKEY_NAME            ("DEVICEKEY")
#define MASTERKEY_NAME            ("MASTERKEY")
#define CONTENTKEY_NAME           ("CONTENTKEY")
#define MASTERDATA1_NAME          ("MASTERDATA1")
#define MASTERDATA2_NAME          ("MASTERDATA2")
#define HASH_NAME                 ("HASH")

#define AT_DEVICE_KEY_MAX_LEN     (2048)
#define AT_CONTENT_KEY_MAX_LEN    (2048)
#define AT_MASTER_KEY_MAX_LEN     (2048)
#define AT_MASTER_DATA_MAX_LEN    (4096)
#define AT_DATA_ONE_MAX_LEN       (4000)
#define AT_HASH_MAX_LEN           (256)
#define VSIM_HASH_LEN             (32)
#define DIEID_TYPE_MAX            (20)
#define DIEID_PARA_NUM            (1)
...
#define AT_ANT_TEMPPRTEVENT_H            (1)
#define AT_ANT_TEMPPRTEVENT_L            (0)
#endif
...
#if( FEATURE_ON == MBB_WPG_COMMON )
#define AT_COPS_SPEC_SRCH_TIME                             (240000)             /* COPS指定搜网时间 */
#else
...
enum AT_TSIMSWITCH_ENUM
{
    AT_TSIMSWITCH_SOFTWARE      =0, 
    AT_TSIMSWITCH_NOSIMREG,
    AT_TSIMSWITCH_SIMCHIP,
    AT_TSIMSWITCH_EXSIM,
    AT_TSIMSWITCH_EXESCM,
};
#endif
enum B64ReultType{
    b64Result_OK=0,
...
#endif
#define  AT_RSFR_RSFW_SUBNAME_LEN   12           /* SUBNAME长度不超过12 */
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
typedef TAF_UINT8 AT_I_TYPE;
#define AT_I_USE0_TYPE               0
#define AT_I_USE1_TYPE               1
#define AT_I_USE2_TYPE               2
#define AT_I_USE3_TYPE               3
#define AT_I_USE4_TYPE               4
#define AT_I_USE5_TYPE               5
#endif
...
#if (FEATURE_ON == MBB_OPERATOR_INDUSTRYCARD)
enum ENUM_UPDATE_VERSION_STATE
{
    UPDATE_STATE_NO_NEW_VERSION = 0,
    UPDATE_STATE_HAVE_NEW_VERSION,
    UPDATE_STATE_CHECKING_NEW_VERSION,
    UPDATE_STATE_DLOADING_NEW_VERSION,
    UPDATE_STATE_FAILED_TO_CHECK_VERSION,
    UPDATE_STATE_COMPLETED_DLOAD_NEW_VERSION,
    UPDATE_STATE_FAILED_TO_DIAL,
    UPDATE_STATE_FAILED_TO_DLOAD_VERSION,
    UPDATE_STATE_FAILED_TO_INSTALL_VERSION
};
#endif
...
#if (FEATURE_ON == MBB_COMMON)
#define AT_FEATURE_MAX                (25) /* 增加四项特性: BATTERY, EXCHARGE, SDCARD, WIRELESS-CHARGE,USB3.0,新增特性FTYRESET.*/
#else
...
*****************************************************************************/
#if(FEATURE_ON == MBB_FEATURE_VSIM_HUK)
extern VOS_CHAR g_cDeviceKey[AT_DEVICE_KEY_MAX_LEN];
extern VOS_CHAR g_cMasterKey[AT_MASTER_KEY_MAX_LEN];
extern VOS_CHAR g_cContentKey[AT_CONTENT_KEY_MAX_LEN];
extern VOS_CHAR g_cMasterData1[AT_MASTER_DATA_MAX_LEN];
extern VOS_CHAR g_cMasterData2[AT_MASTER_DATA_MAX_LEN];
extern VOS_CHAR g_cHash[AT_HASH_MAX_LEN];
#endif/*FEATURE_ON == MBB_FEATURE_VSIM_HUK*/
...
#if(FEATURE_ON == MBB_WPG_COMMON)
#if(FEATURE_ON == MBB_FEATURE_VDF_SIMLOCKEX)
extern VOS_UINT32 At_ProcSimLockExPara(
    VOS_UINT8                           ucIndex,
    VOS_UINT8                           *pucData,
    VOS_UINT16                          usLen
);
...
#if(FEATURE_ON == MBB_FEATURE_ESIM_SWITCH)
extern VOS_UINT32 AT_SetTSimSwitchPara(VOS_UINT8 ucIndex);
#endif
...
#if(FEATURE_ON == MBB_FEATURE_ESIM_SWITCH)
extern VOS_UINT32 At_QryTSimSwitchPara(VOS_UINT8 ucIndex);
#endif
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern VOS_UINT32   At_SetCmerPara(VOS_UINT8 ucIndex);
extern VOS_UINT32 AT_QryUsimstatusPara(VOS_UINT8 ucIndex);
#endif
...
#if(FEATURE_ON == MBB_CHG_BQ27510)
extern VOS_UINT32   At_QryBatSn(TAF_UINT8 ucIndex);
extern VOS_UINT32   At_SetBatSn(TAF_UINT8 ucIndex);
extern VOS_UINT32   At_QryFwUp(TAF_UINT8 ucIndex);
#endif

#if(FEATURE_ON == MBB_USB_FTEN_SWITCH)
extern VOS_UINT32 At_QryUsbSel(TAF_UINT8 ucIndex);
extern VOS_UINT32 At_SetUsbSel(TAF_UINT8 ucIndex);
extern VOS_UINT32 At_TestUsbSel(TAF_UINT8 ucIndex);
#endif
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern TAF_UINT32   At_QryERROR(VOS_UINT8 ucIndex);
#endif
/*新增的hspa AT命令设置函数*/
...
/*添加AT*QOSIG*/
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern TAF_UINT32   At_QryQOSIG(TAF_UINT8 ucIndex);
extern TAF_UINT32   At_QryERROR(TAF_UINT8 ucIndex);
#endif
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern VOS_UINT32 AT_QryAntPara(VOS_UINT8 ucIndex);
extern TAF_VOID AT_QryParaRspAntProc (
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern VOS_UINT32 AT_QryAnt(VOS_UINT8 ucIndex);
#endif
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern VOS_UINT32 MN_PH_CINDANTPARA(
    VOS_INT16                           *psCpichRscp,
    VOS_INT16                           *psCpichEcNo,
    VOS_UINT8                           *pucRssi,
    VOS_UINT32                          *pulCellId
...
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern VOS_VOID  AT_QryParaAntProc(
    VOS_UINT8                           ucIndex,
    VOS_UINT8                           OpId,
    VOS_VOID                           *pPara
);
...
/*  添加AT*QOSIG?    查询*/
#if(FEATURE_ON == MBB_FEATURE_BOX_FTEN)
extern VOS_VOID  AT_QryParaQosigProc(
    VOS_UINT8                           ucIndex,
    VOS_UINT8                           OpId,
    VOS_VOID                           *pPara
);
extern VOS_VOID  AT_QryParaErrorProc(
    VOS_UINT8                           ucIndex,
    VOS_UINT8                           OpId,
    VOS_VOID                           *pPara
);
#endif/*end (BSP_CONFIG_BOARD_WINGLE_MS2172S_818)*/
...
#if 0
#if (MBB_COMMON == FEATURE_ON) 
extern VOS_UINT32 At_QryCsosPara(VOS_UINT8 ucIndex);
extern VOS_UINT32 At_SetCsosPara(VOS_UINT8 ucIndex);
#endif
#endif
...
typedef struct 
{
    unsigned long  rf_band_for_ante;  
    unsigned long  ant_type;
    unsigned long  support_switch_type;
    unsigned long  support_soft_switch;
}ante_switch_handle;
...
extern int anten_switch_set(unsigned long ant_type,unsigned long in_or_out);
extern int anten_switch_get(unsigned long ant_type);
#endif
...
#if (FEATURE_ON == MBB_FEATURE_VSIM_HUK)
extern  VOS_UINT32 VSim_RestoreCardModeNV(VOS_VOID);
extern  VOS_UINT32 VSim_WriteNV(TAF_PH_MASTER_KEY_HUK_STRU *pMasterKey);
extern  VOS_UINT32 VSim_WriteFile(const char *fileName,const char *pData, VOS_UINT32 uLength);
extern  VOS_UINT32 VSIM_Get_Rand_Num(VOS_UINT8 *data, VOS_UINT32 len);
extern  VOS_UINT32 VSIM_Die_Id_Get_Random_Num(VOS_UINT8 *data, VOS_UINT32 len);
#endif/*end (FEATURE_ON == MBB_FEATURE_VSIM_HUK)*/
