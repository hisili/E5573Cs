...
enum TAF_ERROR_CAUSE_ENUM
{
    TAF_ERROR_CAUSE_SUCCESS                                         = 0,
    TAF_ERROR_CAUSE_SIM                                             = 1,
    TAF_ERROR_CAUSE_ATD                                             = 2,
    TAF_ERROR_CAUSE_NWERROR1                                        = 3,
    TAF_ERROR_CAUSE_NWERROR2                                        = 5,
    TAF_ERROR_CAUSE_DEFAULT                                         = 10,
};
typedef  VOS_UINT8  TAF_ERROR_CAUSE_ENUM_UINT8;
#endif
/* [10.5.4.8] Called party subaddress */
/*============================================================================*/
