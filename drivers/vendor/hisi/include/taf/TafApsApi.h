...
enum TAF_PS_MSG_ID_ENUM
{
    ...
    ID_MSG_TAF_PS_SET_APN_ATTACH_SWITCH_REQ                 = TAF_PS_MSG_ID_BASE + 0x0153,  /* _H2ASN_MsgChoice  */
    ID_MSG_TAF_PS_GET_APN_ATTACH_STATE_REQ                  = TAF_PS_MSG_ID_BASE + 0x0154,  /* _H2ASN_MsgChoice  */
#endif
...
enum TAF_PS_EVT_ID_ENUM
{
    ...
    ID_EVT_TAF_PS_SET_APN_ATTACH_SWITCH_CNF                 = TAF_PS_EVT_ID_BASE + 0x0223,           /* _H2ASN_MsgChoice  */
    ID_EVT_TAF_PS_GET_APN_ATTACH_STATUS_CNF                 = TAF_PS_EVT_ID_BASE + 0x0224,           /* _H2ASN_MsgChoice  */
#endif
...
typedef struct
{
    ...
    VOS_UINT32                          OP_SignallingIndication       : 1;
    VOS_UINT32                          OP_SrcStatisticsDescriptor    : 1;
    TAF_UINT32                          OP_Spare                : 18;    /*Reserved*/
#else
...
#if ( FEATURE_ON == MBB_WPG_COMMON )
#if ( FEATURE_ON == MBB_FEATURE_VDF_ATTACH_APN )
...
#endif /*FEATURE_ON == MBB_FEATURE_VDF_ATTACH_APN*/
