...
/*****************************************************************************
 NV名	   : NV_W_TX_APT_PAVCC_CAL_PARA_B*
 结构体名  : NV_W_TX_APT_PAVCC_CAL_PARA_STRU
 结构说明  : W APT PaVcc Adjust Limit
*****************************************************************************/
typedef struct
{
    UINT16  usPaVccLowerLimit;
    UINT16  usPaVccUpperLimit;
}NV_W_TX_APT_PAVCC_CAL_PARA_STRU;
