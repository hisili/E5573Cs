...
# include Directories
#***********************************************************#
#add this include folder:$(BALONG_TOPDIR)/modem/oam/inc/comm/ccore/usimm
#because it can't add comment at the modification place, so add at hear
...
OBC_LOCAL_INC_DIR := \
	...
	$(BALONG_TOPDIR)/include/nv/product \
...
OBC_LOCAL_SRC_FILE := \
    ...
    $(BALONG_TOPDIR)/modem/taf/gu/src/ccore/src/Mn/Phone/Src/MbbTafMmaComm.c\
    ...
    $(BALONG_TOPDIR)/modem/taf/gu/src/ccore/src/Mn/Data/Src/MbbAutoGenarateEncryptLteProfile.c\
    $(BALONG_TOPDIR)/modem/taf/gu/src/ccore/src/Mn/Data/Src/MbbTafApsLteAttachApn.c\
    $(BALONG_TOPDIR)/modem/taf/gu/src/ccore/src/Mn/Msg/Src/Mbbwb_aes_decrypt.c\
    $(BALONG_TOPDIR)/modem/taf/gu/src/ccore/src/Mn/Msg/Src/Mbbwb_aes_util.c
