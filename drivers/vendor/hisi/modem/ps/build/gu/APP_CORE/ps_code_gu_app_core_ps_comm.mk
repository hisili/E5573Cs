...
PS_COMM_SRC_FILES        := \
        ...
        $(TAFDIR)/comm/src/acore/at/src/MbbAtAcoreCommon.c\
        $(TAFDIR)/comm/src/mcore/TAF/Lib/Src/MbbTafApsApi.c\
        $(TAFDIR)/comm/src/acore/at/src/MbbAtEventReport.c\
...
ifeq ($(MBB_FEATURE_VSIM_HUK),FEATURE_ON)
PS_COMM_SRC_FILES        += \
        $(TAFDIR)/comm/src/acore/at/src/AtAesKeyaEncrypt.c\
        $(TAFDIR)/comm/src/acore/at/src/AtAesKeybEncrypt.c\
        $(TAFDIR)/comm/src/acore/at/src/AtAesDecrypt.c\
        $(TAFDIR)/comm/src/acore/at/src/AtAesUtil.c\
        $(TAFDIR)/comm/src/acore/at/src/AtSha256.c\
...
ifeq ($(MBB_FEATURE_FILE_OPERATION),FEATURE_ON)
PS_COMM_SRC_FILES        += \
        $(TAFDIR)/comm/src/acore/at/src/AtCmdRsfrEx.c\
