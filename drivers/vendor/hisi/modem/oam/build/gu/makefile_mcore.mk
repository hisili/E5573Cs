...
ifneq ($(MBB_SIMLOCK_FOUR),FEATURE_ON)
ifneq ($(MBB_SIMLOCK_THREE),FEATURE_ON)
ifeq ($(CFG_CONFIG_SIMLOCK_2_1),YES)
OBC_LOCAL_USER_OBJ_FILE := $(GUMSP_DIR)/build/comm/MODEM_CORE/Lib/simlock2.1/Omdsate680_MD5.o 
else
