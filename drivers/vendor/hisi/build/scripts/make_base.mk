...
OBB_APP_PLATFORM    ?=$(app_platform)
OBB_SUBMODEL_BUILD  ?=$(submodel_build)
OBB_CORE_NAME       ?=$(core)
...
OBB_PRODUCT_E8378WS_210_CUSTOM  ?=$(custom)
export OBB_PRODUCT_E8378WS_210_CUSTOM
endif
...
# eUAP path define
ifeq ($(strip $(OBB_APP_PLATFORM)),atpv2)
OBB_eUAP_DIR=$(BALONG_TOPDIR)/modem/atpv2
else
...
export BALONG_TOPDIR OBB_PRODUCT_NAME OBB_APP_PLATFORM OBB_SUBMODEL_BUILD OBB_CORE_NAME OBB_VERBOSE OBB_DISTCC OBB_BUILD_TYPE OBB_ANDROID_DIR CONFIG_ENABLE_TEST_CODE
