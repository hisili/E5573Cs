#*****************************************************************************
# History :
#		2012-03-23 Created by zhaijiye/00199916, Makefile for ccore
#*****************************************************************************
...
CC_FLAGS				:= -mthumb-interwork -mlong-calls -c -fno-feature-proxy -fdollars-in-identifiers -O2 -DCPU=ARMARCH7 -DTOOL_FAMILY=diab -DTOOL=diab -D_WRS_KERNEL            -DARMEL -DPRJ_BUILD -D_WRS_KERNEL -D_VSB_CONFIG_FILE=\"$(VSB_CONFIG_FILE)\"
