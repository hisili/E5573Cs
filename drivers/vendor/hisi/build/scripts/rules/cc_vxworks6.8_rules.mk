...
OBC_CC_OPTION := -c -t7 -msoft-float -fdollars-in-identifiers \
	...
	-Wvolatile-register-var -mthumb-interwork -mlong-calls
...
OBC_AS_OPTION   ?= -c -t7 -msoft-float -fdollars-in-identifiers -fno-builtin -fvolatile -fno-feature-proxy -fno-zero-initialized-in-bss -xassembler-with-cpp  -MD -mthumb-interwork -mlong-calls
OBC_AS_DEFINES  := -D_WRS_KERNEL -DCPU_CORTEXA8 -DARMMMU=ARMMMU_CORTEXA8 \
	-DARMCACHE=ARMCACHE_CORTEXA8 -DIP_PORT_VXWORKS=68 -DINET -DARMEL
LOCAL_AS_FLAGS  := $(OBC_AS_OPTION) $(OBC_AS_DEFINES) 

#BEGIN DTS2013091209318 x00202188 2013/09/12 modified
# 终端公司发文规定，Vxworks可以不做fortify检查
SOURCEANALYZER :=
#END   DTS2013091209318 x00202188 2013/09/12 modified
