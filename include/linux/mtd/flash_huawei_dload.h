...
typedef struct
{
    ...
    uint32 addr; /*数据段的内存地址*/
    uint32 len;  /*数据段的长度*/
}double_file_info;
typedef struct
{
    uint32 restore_magic;  /*是否修复标记*/
    uint32 restore_fail_times; /*当前镜像连续修复失败次数,最大为3次*/
}double_restore_info;
