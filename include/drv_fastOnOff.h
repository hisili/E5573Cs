...
/* 快速开关机命令字,与ATPV2侧 platform_api_euap.h里定义保持一致 */
#define FAST_ON_OFF_CMD 'F'
#define FASTONOFF_FAST_ON_MODE    _IOWR(FAST_ON_OFF_CMD, 0, unsigned long) /* 退出假关机或者未进入假关机 */
#define FASTONOFF_FAST_OFF_MODE   _IOWR(FAST_ON_OFF_CMD, 1, unsigned long) /* 进入假关机 */
